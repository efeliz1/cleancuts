        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <span class="navbar-text ml-auto">
                    ...
                    <a class="nav-link float-sm-right text-light" data-widget="pushmenu" href="#">Hello, Barber <%=session.getAttribute("user_name")%> !</a>
                            ...
                            <tbody>
                                ...
                                <%
                                    try {
                                        ...
                                        String sql = "select * from appointment where barber = '" + userName + " '";
                                ...
                                <tr>
                                    ...
                                    <td><a class="btn btn-success" value="Confirm" id="confirm" method="POST" href="confirmAppointment.jsp?id=<%=resultSet.getString(1)%>">Confirm</a></td>

                                    <% } else if (status.equalsIgnoreCase("Confirmed")) {%>
                                    <td><input type="submit" class="btn btn-danger" value="Confirmed" id="confirm" href="confirmAppointment.jsp?id=<%=resultSet.getString(1)%>" disabled></td>
